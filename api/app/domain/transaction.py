...
#: portanto neutras no fluxo (Entrou/Saiu). O pagamento de fatura NÃO entra
#: aqui: no modelo de caixa ele é o gasto (sai da conta), e o fluxo já ignora
#: as transações do cartão (a perna "Pagamento recebido" no cartão).
